import torch
import os
from ifair.models.fair_repr import FairRepr
from ifair.utils.loss import weighted_cross_entropy, weighted_mse, weighted_mae, weighted_gifair_grp
from ifair.utils.mlp import MLP
import numpy as np
import math
